...
/**
 * This class is used to display a exception.
 * It provides a text area to display the exception information
 *
 * @author Jeff Tassin
 */
public class TSErrorPanel2 extends JETAPanel
{
    ...
    * @param msg a message to include with the exception msg
    * @param e the exception that was thrown.  The error message of
    *    this exception will be displayed.
    */
