...
/**
 * This is a utility dialog that can be used to display 
 * an Exception.
 *
 * @author Jeff Tassin
 */
public class TSErrorDialog2 extends JETADialog
{
   ...
   {
      TSErrorDialog2 dlg = (TSErrorDialog2)JETAToolbox.createDialog( TSErrorDialog2.class, owner, true );
