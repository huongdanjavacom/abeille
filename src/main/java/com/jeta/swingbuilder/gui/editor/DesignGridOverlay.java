...
public class DesignGridOverlay extends JPanel implements GridCellListener, GridOverlay {
	...
	static {
		try {
			...
			m_invalid_image = loader.loadImage("images/forms/invalid_comp.gif");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
    ...
    public void paintComponent(Graphics g) {
		...
		int clip_x1 = m_clip_rect.x;
		int clip_x2 = m_clip_rect.x + m_clip_rect.width;
		int clip_y1 = m_clip_rect.y;
		int clip_y2 = m_clip_rect.y + m_clip_rect.height;
