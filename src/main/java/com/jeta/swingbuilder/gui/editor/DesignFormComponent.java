...
public class DesignFormComponent extends FormComponent implements GridViewListener {
	...
	private JPanel createControlsPanel() {
		...
		JButton btn = new JButton(AppResourceLoader.getImage("images/forms/form_control_collapse.gif"));
		...
		btn = new JButton(AppResourceLoader.getImage("images/forms/form_control_edit.gif"));
		btn.setPreferredSize(d);
		btn.setMinimumSize(d);
		btn.setBorderPainted(false);
		btn.setFocusPainted(false);
		...
		m_btnpanel.add(javax.swing.Box.createHorizontalStrut(2));
		btn = new JButton(AppResourceLoader.getImage("images/forms/form_control_grid.gif"));
		btn.setPreferredSize(d);
		btn.setMinimumSize(d);
		btn.setBorderPainted(false);
		btn.setFocusPainted(false);
	...
	public void setGridViewVisible(boolean bvis) {
		...
		if (bvis) {
			m_expand_btn.setIcon(AppResourceLoader.getImage("images/forms/form_control_collapse.gif"));
		}
		else {
			m_expand_btn.setIcon(AppResourceLoader.getImage("images/forms/form_control_expand.gif"));
		}
	}
